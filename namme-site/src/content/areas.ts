 ...
 * location pages, because "driveways Derby" or "builders in Mickleover" is where
 * the commercial intent sits — far more than on the generic service term.
 *
...
export const areas: Area[] = [
  ...
  },
  {
    ...
    council: "Derby City Council",
    housingStock:
      "Large 1980s–90s estates in Oakwood, older council-built and inter-war stock in Chaddesden. Generous frontages across both, which is why so much of our work here is driveways and front boundary walls.",
    planningNotes:
  ...
  },
  {
    ...
    popularServices: ["refurbishments", "extensions", "painting-decorating"],
    projectSlugs: [],
  },
  {
